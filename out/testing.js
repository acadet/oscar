...
var AsyncMock = (function () {
    ...
    AsyncMock.prototype.setSuccess = function (func) {
        this._success = func;
        return this;
    };

    AsyncMock.prototype.setError = function (func) {
        this._error = func;
        return this;
    };

    AsyncMock.prototype.mustFail = function () {
        this._mustFail = true;
        return this;
    };

    AsyncMock.prototype.run = function () {
        if (this._mustFail) {
            this._error();
        } else {
            this._success();
...
var A = (function (_super) {
    ...
    A.prototype.hiddenFunc = function () {
        throw new Error('hiddenFunc A');
    };

    A.prototype.aTest = function () {
        var a;
    ...
    A.prototype.anAsyncTest = function () {
        var _this = this;
        var mock;

        mock = new AsyncMock();

        mock.setSuccess(function () {
            setTimeout(function () {
...
var TestLauncher = (function () {
    function TestLauncher() {
    }
    TestLauncher.run = function () {
        var suite;
